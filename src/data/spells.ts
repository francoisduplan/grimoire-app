...
export const SPELLS_DATA: Spell[] = [
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: "La graisse ininflammable recouvre le sol dans un carré de 10 pieds centré sur un point à portée et le transforme en terrain difficile. Chaque créature se trouvant dans la zone doit réussir un jet de sauvegarde de Dextérité ou être à terre.",
